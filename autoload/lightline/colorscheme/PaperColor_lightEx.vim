" =============================================================================
" Filename: autoload/lightline/colorscheme/PaperColor_lightEx.vim
" Author: TKNGUE
" License: MIT License
...
let s:p.normal.warning = [ [ s:background, s:orange ] ]
let s:p.normal.ok = [ [ s:background, s:green ] ]

let g:lightline#colorscheme#PaperColor_lightEx#palette = lightline#colorscheme#fill(s:p)
